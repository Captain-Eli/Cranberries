...
class Gold(Item):
    def __init__(self, amt):
        self.amt = amt
        super(Gold, self).__init__(name="Gold", description="{} round coin/s probably made of silver.".format(str(self.amt)), value=self.amt)
